...
export function CampaignStatusPreview({
  campaigns,
}: CampaignStatusPreviewProps) {
  return (
    <Card className="col-span-full">
      ...
      <CardContent>
        {campaigns.length === 0 ? (
          <div className="text-center py-10 text-zinc-500 space-y-3 border border-dashed border-zinc-200 rounded-lg">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-zinc-400 max-w-sm mx-auto">
                Create a campaign to define your ICP, offer, and target audience.
              </p>
            </div>
            <Link href="/campaigns" className="inline-block pt-1">
